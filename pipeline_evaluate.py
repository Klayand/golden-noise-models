...
if __name__ == '__main__':
      ...
      metric_version = 'PickScore'     # ['PickScore', 'HPSv2', 'AES', 'ImageReward']
      ...
      # create the subset to accelerate the filter speed
      bad_datasets = Subset(bad_datasets, indices=range(20000, 25000))
      ...
      if DDP:
            ...
            loader = DataLoader(bad_datasets, batch_size=1, num_workers=32, pin_memory=True, sampler=sampler)
      else:
            loader = DataLoader(bad_datasets, batch_size=1, num_workers=32, pin_memory=True, shuffle=True)
      ...
      with open('bad_sample_pick_50000.json', 'w', encoding='utf-8') as f:
            # evaluate samples
